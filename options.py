...
parser.add_argument('--de_type', nargs='+', default=['denoise_15', 'denoise_25', 'denoise_50', 'derain', 'dehaze', 'deblur', 'enhance', 'raindrop'],
...
parser.add_argument('--raindrop_dir', type=str, default='/data/zzd/Datasets/NTIRE/RainDrop/train/',
                    help='where training images of dehazing saves.')
parser.add_argument('--output_path', type=str, default="output/", help='output save path')
parser.add_argument('--ckpt_path', type=str, default="ckpt/Denoise/", help='checkpoint save path')
parser.add_argument("--ckpt_dir",type=str,default="ExpertRestore",help = "Name of the Directory where the checkpoint is to be saved")
